...
#define BUFFER_MAX_LENGTH 15

/*连击时停止发送松开事件*/
#define STOP_SEND_RELEASE 1

/*捕获连击结束事件*/
#define CATCH_HIT_STOP_EVENT 0

/*检测全部事件*/
//1:组合键触发时单键的信息也会触发,可以同时检测多个单键事件
//0:组合键与单键做严格区分,组合键按下不会触发单键信息,不可以同时检测多个单键事件
#define DETECT_ALL_SINGLE_KEYS 1
